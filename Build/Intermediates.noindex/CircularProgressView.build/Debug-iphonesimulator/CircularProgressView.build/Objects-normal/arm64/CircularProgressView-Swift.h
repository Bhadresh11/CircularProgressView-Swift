...
#ifndef CIRCULARPROGRESSVIEW_SWIFT_H
#define CIRCULARPROGRESSVIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CircularProgressView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20CircularProgressView11AppDelegate")
...
SWIFT_CLASS("_TtC20CircularProgressView20CircularProgressView")
...
SWIFT_CLASS("_TtC20CircularProgressView13SceneDelegate")
...
SWIFT_CLASS("_TtC20CircularProgressView14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified viewContainerProgress;
- (void)viewDidLoad;
